...
@Entity
@Table(name = "Personnel2")    //Tablo adımızı değiştirebiliyoruz.
public class Personnel2 {
    ...
    public Personnel2(int personnelId, String firstName, String lastName, Date birthOfDate, String personnelNumber,
